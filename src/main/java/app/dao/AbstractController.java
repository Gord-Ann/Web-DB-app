...
public abstract class AbstractController<T extends Identifiable> implements Dao<T> {
    ...
    public AbstractController(DataSource dataSource, String getAllQuery, String getByIdQuery,
