...
abstract class AbstractCaching<T extends Identifiable> extends AbstractController<T> {
    private Map<Long, T> cache;

    public AbstractCaching(DataSource dataSource, String getAllQuery, String getByIdQuery,
